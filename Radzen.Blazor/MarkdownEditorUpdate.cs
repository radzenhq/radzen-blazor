...
public class MarkdownEditorUpdate
{
    ...
    /// <summary>The text segments of <see cref="Html" /> as flat triples of source start, source end and rendered length.</summary>
    public int[]? Segments { get; set; }

    /// <summary>The whole markdown text, sent when the source textarea must be replaced.</summary>
    public string? Text { get; set; }

    /// <summary>The selection start in the markdown text after the edit.</summary>
    public int SelectionStart { get; set; }

    /// <summary>The selection end in the markdown text after the edit.</summary>
