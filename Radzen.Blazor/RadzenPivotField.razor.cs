...
namespace Radzen.Blazor
{
    ...
    public partial class RadzenPivotField<TItem> : ComponentBase
    {
        ...
        /// <summary>
        /// Gets or sets the filter mode for this column.
        /// </summary>
        [Parameter]
        ...
        /// <summary>
        /// Gets or sets the text property for list box filtering.
        /// </summary>
        [Parameter]
        public string TextProperty { get; set; }

        /// <summary>
        /// Gets or sets the value property for list box filtering.
        /// </summary>
        [Parameter]
        public string ValueProperty { get; set; }

        /// <summary>
        /// Gets or sets whether to allow checkbox list virtualization.
        /// </summary>
        [Parameter]
        ...
        protected override void OnInitialized()
        {
            if (PivotGrid != null)
            {
                var canSetFilterPropertyType = (FilterMode ?? PivotGrid.FilterMode) == Radzen.FilterMode.CheckBoxList && FilterTemplate == null;
