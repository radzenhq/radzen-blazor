...
internal sealed class ImageRegistry(ImageDecoders decoders)
{
    private readonly ResourceNameAllocator<SourceId, OutputImage> images = new(ContentResourcePrefixes.Page.Image);
    private readonly ResourceNameAllocator<SourceId, OutputImage> interpolated = new(ContentResourcePrefixes.Page.Image + "o");
