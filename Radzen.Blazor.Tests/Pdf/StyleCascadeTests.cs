...
public class StyleCascadeTests
{
    ...
    [Fact]
    public void UnsetEverywhere_ParagraphFormattingUsesTheBuiltInDefaults()
    {
        var document = Builder(out var section);
        var paragraph = section.Blocks.AddParagraph("Plain");
    ...
    [Fact]
    public void NamedStyle_ParagraphFormattingApplies()
    {
        var document = Builder(out var section);
        var style = document.Styles.Add("Quote");
        style.SpacingBefore = Unit.FromPoint(7);
        style.SpacingAfter = Unit.FromPoint(11);
        style.LeftIndent = Unit.FromPoint(13);
    ...
    [Fact]
    public void LocalParagraphValue_WinsOverTheNamedStyle()
    {
        var document = Builder(out var section);
        var style = document.Styles.Add("Quote");
        style.SpacingBefore = Unit.FromPoint(7);
        ...
        paragraph.LeftIndent = Unit.FromPoint(5);
    ...
    [Fact]
    public void BaseStyleChain_NearestAncestorSettingTheValueWins()
    {
        var document = Builder(out var section);
        var root = document.Styles.Add("Root");
        root.SpacingBefore = Unit.FromPoint(4);
        root.LeftIndent = Unit.FromPoint(30);
        var middle = document.Styles.Add("Middle", "Root");
        middle.SpacingBefore = Unit.FromPoint(9);
