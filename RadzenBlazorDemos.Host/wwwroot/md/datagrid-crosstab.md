# DataGrid: Crosstab data

Blazor Data Grid supports crosstab data sources.

Keywords: datagrid, bind, load, data, loaddata, crosstab, rows, columns

> API reference: [RadzenDataGrid API](https://blazor.radzen.com/api/datagrid.md)

## Examples

## DataGrid crosstab data support

Display crosstab data in a Blazor DataGrid by pivoting rows into columns - summarize values across two dimensions, such as sales by product and month, in a single grid.
