# DataGrid: DataTable data

Blazor Data Grid supports DataTable sources.

Keywords: datagrid, bind, load, data, loaddata, datatable

> API reference: [RadzenDataGrid API](https://blazor.radzen.com/api/datagrid.md)

## Examples

## DataGrid DataTable support

Bind a Blazor DataGrid to a System.Data.DataTable and render its columns and rows directly - ideal for ADO.NET results, stored procedures, or legacy data without a typed model.
