...
Show how a price opened, closed, and swung with a Blazor candlestick chart - one candle per trading period. Free and open source.

Keywords: chart, graph, candlestick, ohlc, financial, stock

## Examples

## Radzen Blazor Chart candlestick series
