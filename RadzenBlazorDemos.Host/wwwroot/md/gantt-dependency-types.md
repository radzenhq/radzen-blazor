...
Keywords: gantt, dependency, link, finish-to-start, start-to-start, finish-to-finish, start-to-finish
...
RadzenGantt supports all four standard dependency types: Finish-to-Start, Start-to-Start, Finish-to-Finish, and Start-to-Finish. Set the `Type` property on each `GanttDependency`.
