...
Keywords: form, edit, color, picker

> API reference: [RadzenColorPicker API](https://blazor.radzen.com/api/colorpicker.md)
...
<div class="rz-p-0 rz-p-md-12">
    <RadzenStack Orientation="Orientation.Horizontal" Gap="1.5rem" Wrap="FlexWrap.Wrap" class="rz-p-4 rz-mb-6 rz-border-radius-1" Style="border: var(--rz-grid-cell-border);">
        <RadzenStack Orientation="Orientation.Horizontal" AlignItems="AlignItems.Center" Gap="0.5rem">
            <RadzenCheckBox @bind-Value=@showHSV Name="HSV" />
            <RadzenLabel Text="Show HSV picker" Component="HSV" />
        </RadzenStack>
        <RadzenStack Orientation="Orientation.Horizontal" AlignItems="AlignItems.Center" Gap="0.5rem">
            <RadzenCheckBox @bind-Value=@showRGBA Name="RGBA" />
            <RadzenLabel Text="Show RGBA picker" Component="RGBA" />
        </RadzenStack>
        <RadzenStack Orientation="Orientation.Horizontal" AlignItems="AlignItems.Center" Gap="0.5rem">
            <RadzenCheckBox @bind-Value=@showColors Name="Colors" />
            <RadzenLabel Text="Show Predefined colors" Component="Colors" />
        </RadzenStack>
        <RadzenStack Orientation="Orientation.Horizontal" AlignItems="AlignItems.Center" Gap="0.5rem">
            <RadzenCheckBox @bind-Value=@showButton Name="OKButton" />
            <RadzenLabel Text="Show OK button" Component="OKButton" />
        </RadzenStack>
        <RadzenStack Orientation="Orientation.Horizontal" AlignItems="AlignItems.Center" Gap="0.5rem">
            <RadzenCheckBox @bind-Value=@showArrow Name="Arrow" />
            <RadzenLabel Text="Show arrow" Component="Arrow" />
        </RadzenStack>
    </RadzenStack>
    <RadzenRow class="rz-my-12">
        <RadzenColumn Size="12" SizeMD="6" class="rz-text-align-center rz-text-align-md-end">
        ...
        <RadzenColumn Size="12" SizeMD="6" class="rz-text-align-center rz-text-align-md-start">
            <RadzenText TextStyle="TextStyle.H6" TagName="TagName.P" class="rz-mt-4 rz-mt-md-12">Choose T-Shirt color</RadzenText>
            <RadzenColorPicker @bind-Value=@color ShowHSV=@showHSV ShowRGBA=@showRGBA ShowColors=@showColors ShowButton=@showButton ShowArrow=@showArrow Change=@OnChange />
        </RadzenColumn>
    </RadzenRow>
...
<RadzenStack Gap="1rem" class="rz-p-sm-12" AlignItems="AlignItems.Center">
    <RadzenStack Orientation="Orientation.Horizontal" AlignItems="AlignItems.Center" Style="width: 200px;">
        <RadzenLabel Text="Large" Style="width: 80px;" />
        <RadzenColorPicker @bind-Value=@value InputSize="InputSize.Large" />
    </RadzenStack>
    <RadzenStack Orientation="Orientation.Horizontal" AlignItems="AlignItems.Center" Style="width: 200px;">
        <RadzenLabel Text="Medium" Style="width: 80px;" />
        <RadzenColorPicker @bind-Value=@value InputSize="InputSize.Medium" />
    </RadzenStack>
    <RadzenStack Orientation="Orientation.Horizontal" AlignItems="AlignItems.Center" Style="width: 200px;">
        <RadzenLabel Text="Small" Style="width: 80px;" />
        <RadzenColorPicker @bind-Value=@value InputSize="InputSize.Small" />
    </RadzenStack>
    <RadzenStack Orientation="Orientation.Horizontal" AlignItems="AlignItems.Center" Style="width: 200px;">
        <RadzenLabel Text="Extra Small" Style="width: 80px;" />
        <RadzenColorPicker @bind-Value=@value InputSize="InputSize.ExtraSmall" />
    </RadzenStack>
</RadzenStack>
