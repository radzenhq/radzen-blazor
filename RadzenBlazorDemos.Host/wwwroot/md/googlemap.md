...
Demonstration and configuration of Radzen Blazor Google Map component.

> API reference: [RadzenGoogleMap API](https://blazor.radzen.com/api/googlemap.md)

## Examples

## Blazor GoogleMap

Blazor Google Map component for embedding interactive maps. [https://developers.google.com/maps/documentation/javascript/get-api-key](https://developers.google.com/maps/documentation/javascript/get-api-key) [https://developers.google.com/maps/documentation/get-map-id](https://developers.google.com/maps/documentation/get-map-id)
...
{
<RadzenGoogleMap ApiKey="@apiKey" MapId="854792de47144ec6496c14d8" @ref=map Style="height: 400px" Options=@(new Dictionary<string, object> { { "disableDoubleClickZoom", true } })
...
@code {
    ...
    {
        var result = await Http.GetFromJsonAsync<JsonElement>("/api/config/googlemaps");
    ...
    async Task OnMarkerClick(RadzenGoogleMapMarker marker)
    {
        ...
        await JSRuntime.InvokeVoidAsync("showMapInfoWindow", map.UniqueID, marker.Title, message);
    }
