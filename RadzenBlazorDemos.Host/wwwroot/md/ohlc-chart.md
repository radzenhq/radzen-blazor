...
Follow price action with a Blazor OHLC bar chart - open, high, low, and close in one compact tick per period. Free and open source.

Keywords: chart, graph, ohlc, financial, stock, open, high, low, close
        ...
        <RadzenColumn Size="12">
            <RadzenChart Animate="true">
                <RadzenOhlcSeries Data="@stockData" CategoryProperty="Date"
                    ...
                    Title="ACME Corp" BullStroke="#26A69A" BearStroke="#EF5350" />
