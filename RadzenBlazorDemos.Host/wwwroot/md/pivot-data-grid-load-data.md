# PivotDataGrid: LoadData

Bind the Blazor Pivot DataGrid to remote data with the LoadData event, fetching aggregated cross-tab results on demand.

Keywords: pivot, crosstab, analysis, aggregation, drill-down, datagrid, table, loaddata, remote
