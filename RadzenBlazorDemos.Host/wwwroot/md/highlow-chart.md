...
Show the range between a low and a high value for each point with a Blazor high-low chart. Free and open source.

Keywords: chart, graph, highlow, high, low, range, temperature

## Examples

## Radzen Blazor Chart with high-low series

A high-low chart draws a single line from the low to the high of each point - a clean way to show ranges like a day's temperature span or a stock's trading range.
    ...
    <RadzenRow>
        <RadzenColumn Size="12">
            <RadzenChart Animate="true">
                <RadzenHighLowSeries Data="@temperatureData" CategoryProperty="Month"
                    HighProperty="High" LowProperty="Low" Title="Temperature Range"
                    StrokeWidth="3" />
                <RadzenCategoryAxis />
                <RadzenValueAxis>
