# DataGrid: Drag row between DataGrid and Scheduler

This example demonstrates drag and drop rows between DataGrid and Scheduler.

Keywords: datagrid, drag, row, scheduler

> API reference: [RadzenDataGrid API](https://blazor.radzen.com/api/datagrid.md)

## Examples

## Drag and drop rows between DataGrid and Scheduler

Drag Blazor DataGrid rows onto a Scheduler - let users schedule items by dragging them from the grid into the Scheduler.
