...
Keywords: navigation, dropdown

> API reference: [RadzenMenu API](https://blazor.radzen.com/api/menu.md)
...
<RadzenStack Orientation="Orientation.Horizontal" AlignItems="AlignItems.Center" Gap="1rem" class="rz-mb-4">
    <RadzenStack Orientation="Orientation.Horizontal" AlignItems="AlignItems.Center" Gap="0.5rem">
        <RadzenCheckBox @bind-Value=@flyout Name="FlyoutCheckBox" TValue="bool" />
        <RadzenLabel Text="Flyout nested submenus" Component="FlyoutCheckBox" />
    </RadzenStack>
    <RadzenStack Orientation="Orientation.Horizontal" AlignItems="AlignItems.Center" Gap="0.5rem">
        <RadzenCheckBox @bind-Value=@clickToOpen Name="ClickToOpenCheckBox" TValue="bool" />
        <RadzenLabel Text="Click to open" Component="ClickToOpenCheckBox" />
    </RadzenStack>
</RadzenStack>

<div class="rz-p-sm-12" style="margin-bottom: 200px;">
        <RadzenMenu Click="OnParentClicked" Flyout="@flyout" ClickToOpen="@clickToOpen">
