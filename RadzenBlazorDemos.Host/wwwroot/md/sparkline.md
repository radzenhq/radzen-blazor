...
Show a trend inline in word-sized space with a Blazor sparkline - no axes or labels.

Keywords: chart, sparkline

> API reference: [RadzenSparkline API](https://blazor.radzen.com/api/sparkline.md)

## Examples

## Radzen Blazor Sparkline chart

A sparkline is a tiny, word-sized chart with no axes or labels, made to sit inline - in a table cell or next to a number - to show a trend at a glance.
                ...
                <RadzenRow Gap="0" AlignItems="AlignItems.Center">
                    ...
                    <RadzenColumn Size="3" SizeMD="3" class="rz-p-1">
                        <RadzenSparkline style="width: 100%; height: 30px">
                            <RadzenAreaSeries FillMode="FillMode.Gradient" Smooth="true" Data="@people.Tests" Title="Score" CategoryProperty="@nameof(Test.TestName)" ValueProperty="@nameof(Test.Score)" />
                    ...
                    <RadzenColumn Size="3" SizeMD="2" class="rz-p-1">
                        <RadzenSparkline style="width: 80px; height: 30px">
                            <RadzenColumnSeries FillMode="FillMode.Gradient" Data="@people.Tests" Title="Score" CategoryProperty="@nameof(Test.TestName)" ValueProperty="@nameof(Test.Score)" />
...
<RadzenCard class="rz-my-12 rz-p-4 rz-p-md-8 rz-mx-auto" Style="max-width: 800px">
    ...
    <RadzenText TextStyle="TextStyle.H6" TagName="TagName.H4" class="rz-mb-6">
        The second quiz was the easiest for @(people[0].Name) (<RadzenSparkline style="display: inline-block; width: 100px; height: 20px">
                <RadzenColumnSeries FillMode="FillMode.Gradient" Data="@people[0].Tests" Title="Score" CategoryProperty="@nameof(Test.TestName)" ValueProperty="@nameof(Test.Score)" />
        ...
        and @(people[1].Name) (<RadzenSparkline style="display: inline-block; width: 100px; height: 20px">
                <RadzenColumnSeries FillMode="FillMode.Gradient" Data="@people[1].Tests" Title="Score" CategoryProperty="@nameof(Test.TestName)" ValueProperty="@nameof(Test.Score)" />
                <RadzenColumnOptions Margin="2" />
                <RadzenCategoryAxis Visible="false" Padding="-12" />
            </RadzenSparkline>).
    </RadzenText>
