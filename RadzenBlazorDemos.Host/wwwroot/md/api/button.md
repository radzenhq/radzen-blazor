...
|--------|---------|-------------|
| OnClick(MouseEventArgs args) | `Task` | Handles the button click event. This method is called internally when the button is clicked. It prevents multiple simultaneous clicks and invokes the callback. |
