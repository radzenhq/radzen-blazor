# RadzenRadioButtonList API Reference
...
| AriaLabelledBy | `string?` | Gets or sets the id of an external element that labels the radio group. Sets the aria-labelledby attribute. |
...
| VisibleProperty | `string?` | Gets or sets the visible property. |
...
|--------|---------|-------------|
| AddItem(RadzenRadioButtonListItem<TValue> item) | `void` | Adds the item. |
| Refresh() | `void` | Refreshes this instance. |
| RemoveItem(RadzenRadioButtonListItem<TValue> item) | `void` | Removes the item. |
