...
Show planned vs. actual schedule side by side using baseline bars.

Keywords: gantt, baseline, planned, actual, schedule, comparison
...
Set `BaselineStartProperty` and `BaselineEndProperty` to display planned vs. actual schedule. The gray bar behind each task bar represents the original plan.
