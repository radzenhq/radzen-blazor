...
Highlight the longest chain of dependent tasks that determines the project end date.

Keywords: gantt, critical, path, highlight, schedule, dependency
...
Set `ShowCriticalPath="true"` to highlight the longest chain of dependent tasks that determines the project end date. Critical tasks and their links are shown in red.
