...
Use Radzen Blazor PickList component to transfer items between two collections.

Keywords: picklist, list, listbox

> API reference: [RadzenPickList API](https://blazor.radzen.com/api/picklist.md)
