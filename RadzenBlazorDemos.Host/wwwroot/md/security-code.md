...
The Blazor SecurityCode is a multi-box input for one-time passwords (OTP), PINs, and verification codes.

Keywords: security, code, input

> API reference: [RadzenSecurityCode API](https://blazor.radzen.com/api/securitycode.md)
