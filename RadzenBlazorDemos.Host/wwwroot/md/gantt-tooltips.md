...
Show tooltips when hovering over Gantt task bars using TaskMouseEnter and TaskMouseLeave events.

Keywords: gantt, tooltip, hover, task, mouse
...
Use the `TaskMouseEnter` and `TaskMouseLeave` events to show a tooltip when hovering over a task bar.
...
@code {
    ...
    @<RadzenStack Orientation="Orientation.Vertical" Gap="0" class="rz-p-2" Style="min-width: 250px; max-width: 500px;">
        <RadzenText TextStyle="TextStyle.Subtitle1" TagName="TagName.P" class="rz-mb-2" Style="color: var(--rz-tooltip-color);">
            @args.Data?.Name
        </RadzenText>
        <RadzenText TextStyle="TextStyle.H3" TagName="TagName.P" class="rz-mb-2" Style="color: var(--rz-tooltip-color);">
