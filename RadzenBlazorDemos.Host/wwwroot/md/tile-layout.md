...
The Blazor TileLayout builds dashboards from draggable, resizable tiles.

Keywords: tile, layout, grid, dashboard, drag, resize

> API reference: [RadzenTileLayout API](https://blazor.radzen.com/api/tilelayout.md)

## Examples

## Blazor Tile Layout

The Blazor TileLayout builds dashboards from draggable, resizable tiles arranged on a configurable grid.
