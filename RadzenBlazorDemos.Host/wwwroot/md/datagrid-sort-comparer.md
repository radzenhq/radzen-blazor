# DataGrid: Custom Sort Comparer

Sort a column with a custom IComparer, for example ordering id values by their mapped display name.

Keywords: comparer, custom, sort, datagrid, table, dataview
